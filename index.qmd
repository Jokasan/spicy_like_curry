...
only for point guards and then aggregate the data to get a sense of the overall perfromance
by player and team:
...
detach(Pbox.PG)
radialprofile(data=X, title=Pbox.PG$Player, std=FALSE,ncol.arrange = 3,)
